...
# [iq
	...
	config.ParentalControl.retries.extrastationspin.tries = ConfigInteger(default = 3)
	config.ParentalControl.retries.extrastationspin.time = ConfigInteger(default = 3)	
# iq]
