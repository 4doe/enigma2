...
class DefaultWizard(WizardLanguage, DreamInfoHandler):
	...
	def statusCallback(self, status, progress):
		...
		if status == DreamInfoHandler.STATUS_DONE:
			self["text"].setText(_("The installation of the default settings is finished. You can now continue configuring your Settop Box by pressing the OK button on the remote control."))
			self.markDone()
